...
async function seedDatabase() {
    ...
    await GroceryItem.deleteMany() // Clears previous database data before inserting new data
    await GroceryItem.insertMany(groceryChoices) // Inserts Game and Console data array
